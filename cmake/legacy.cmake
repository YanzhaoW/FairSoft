...
ExternalProject_Add(zeromq
  GIT_REPOSITORY https://github.com/zeromq/libzmq GIT_TAG ${zeromq_version}
  ${CMAKE_DEFAULT_ARGS} CMAKE_ARGS
    "-DWITH_PERF_TOOL=ON"
    "-DZMQ_BUILD_TESTS=ON"
    "-DENABLE_CPACK=OFF"
...
set(root_version ${USE_ROOT_VERSION})
...
ExternalProject_Add(root
  ...
  DEPENDS pythia8 vc ${extract_source_cache_target} geant4
  ${LOG_TO_FILE}
)
